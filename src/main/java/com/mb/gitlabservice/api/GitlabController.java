...
public class GitlabController {
     ...
     */
    @GetMapping("/projects")
    @ApiOperation("Get Gitlab Projects.")
    ...
    @ApiOperation("Get all merge requests.")
    ...
    @ApiOperation("Create merge requests.")
    ...
    @ApiOperation("Update merge requests.")
